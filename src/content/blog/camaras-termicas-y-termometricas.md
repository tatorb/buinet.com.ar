...
- **Un tablero eléctrico** que empieza a calentarse en un punto específico. Nadie lo nota porque todo “funciona”, pero ese hotspot suele estar asociado a causas concretas (conexiones flojas, desbalance, sobrecarga). Un [paper técnico citado por ASHRAE/BCx](https://www.ashb.com/wp-content/uploads/2022/06/IS-2022-59.pdf) señala que **~25% de las fallas eléctricas mayores** se atribuyen a **conexiones flojas o defectuosas**. Ese es exactamente el tipo de condición que aparece como temperatura anómala antes de convertirse en un incidente.
...
Un [ejemplo claro es el uso en investigación y operaciones: el centro IAAPS](https://www.axis.com/customer-story/temperature-monitoring-solution-research) (Reino Unido, asociado a la Universidad de Bath) trabajaba con pruebas vinculadas a propulsión marina basada en metanol. El desafío no era únicamente vigilar: era **supervisar condiciones térmicas**, identificar comportamientos anómalos y generar información útil **antes** de que una falla impacte en el sistema.
